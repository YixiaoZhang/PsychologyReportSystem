						...
						<div class="am-tab-panel am-fade am-in am-active" id="tab1">
							<div class="am-g am-margin-top">
								...
								<div class="am-u-sm-8 am-u-md-10">
									<input type="text" id="classesName" name="studentName"
										value="${student.name}">
								</div>
							</div>
							<div class="am-g am-margin-top">
								...
								<div class="am-u-sm-8 am-u-md-10">
									<input type="text" id="assistantName" name="studentId"
										value="${student.id}">
								</div>
							</div>
							...
							<div class="am-g am-margin-top">
								...
								<div class="am-u-sm-8 am-u-md-10">
									<input type="text" id="assistantName" name="studentSex"
										value="${student.sex}">
								</div>
							</div>
							<div class="am-g am-margin-top">
								...
								<div class="am-u-sm-8 am-u-md-10">
									<input type="text" id="assistantId" name="classesName"
